...
IMPLEMENT_MODULE(FB1MorphCompatEditorModule, B1MorphCompatEditor)

void FB1MorphCompatEditorModule::StartupModule()
{
    ...
    FTabSpawnerEntry& Spawner = FGlobalTabmanager::Get()->RegisterNomadTabSpawner(
        ...
        FOnSpawnTab::CreateRaw(this, &FB1MorphCompatEditorModule::SpawnTransferTab))
...
void FB1MorphCompatEditorModule::ShutdownModule()
{
    FGlobalTabmanager::Get()->UnregisterNomadTabSpawner(BlueClientCompatTransferTabName);
...
TSharedRef<SDockTab> FB1MorphCompatEditorModule::SpawnTransferTab(const FSpawnTabArgs& SpawnTabArgs)
{
